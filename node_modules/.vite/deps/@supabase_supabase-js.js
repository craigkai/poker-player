...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-FF6GMAPI.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
      ...
      if (res2.ok) {
        ...
        if (this.method !== "HEAD" && !isReturnMinimal) {
          ...
          if (!text) {
            ...
            data = text;
          } else if (this.headers["Accept"] && this.headers["Accept"].indexOf("application/vnd.pgrst.plan+text") !== -1) {
            data = text;
          } else {
...
var resolveResponse = () => __awaiter6(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-FF6GMAPI.js")).Response;
  }
  return Response;
});
  ...
  _saveSession(session) {
    return __awaiter14(this, void 0, void 0, function* () {
      ...
      if (expiresAt2) {
        ...
        this._startAutoRefreshToken((expiresIn - refreshDurationBeforeExpires) * 1e3, session);
      }
  ...
  _startAutoRefreshToken(value, session) {
    ...
    this.refreshTokenTimer = setTimeout(() => __awaiter14(this, void 0, void 0, function* () {
      ...
      if (!error)
        this.networkRetries = 0;
      if (error instanceof AuthRetryableFetchError && this.networkRetries < NETWORK_FAILURE.MAX_RETRIES)
        this._startAutoRefreshToken(Math.pow(NETWORK_FAILURE.RETRY_INTERVAL, this.networkRetries) * 100, session);
    }), value);
